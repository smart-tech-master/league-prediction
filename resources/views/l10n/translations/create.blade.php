...
@section('content')
    ...
    <div class="report-wrapper">
        ...
        <div class="ads-banner-wrapper">
            <form id="submitForm" action="{{route('l10n.translations.store')}}" method="post">
                @csrf
                        ...
                        @isset($locales)
                            @foreach($locales as $locale)
                                <div class="form-group">
                                    ...
                                    <input type="text" name="text[{{ $locale->code }}]" class="form-control-sm form-control"
                                           value="{{ old('text.' . $locale->code) }}"/>
