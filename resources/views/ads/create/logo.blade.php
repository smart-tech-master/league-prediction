                                ...
                                <select name="leagues[]" id="leagues" multiple="multiple">
                                    @isset($leagues)
                                        @foreach($leagues as $league)
                                            <option
                                                value="{{$league->id}}" {{ in_array($league->id, (old('league') ?? [])) ? ' selected' : null }}>{{$league->name}}</option>
                                        @endforeach
                                    @endisset
                                </select>
                                <input type="checkbox" id="selectAllLeagues">
                                <label for="selectAllLeagues">Select All</label>
    ...
    <script>
        $(function () {
            ...
            $("#selectAllLeagues").click(function () {
                if ($("#selectAllLeagues").is(':checked')) {
                    $("#leagues > option").prop("selected", "selected");
                    $("#leagues").trigger("change");

                } else {
                    $("#leagues > option").prop("selected", "");
                    $("#leagues > option").removeAttr("selected");
                    $("#leagues").trigger("change");
                }
            });
